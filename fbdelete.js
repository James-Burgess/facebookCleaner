// ==UserScript==
// @name			Jimmys's Facebook Cleaner
...
function confirmremovetag() {
    if ($("div.uiLayer:visible:contains('annoying')").length) $("div.uiLayer:visible input[name='answer']:eq(1)").click();
